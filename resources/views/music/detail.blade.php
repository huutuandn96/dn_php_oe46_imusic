            ...
            <div class="comments">
                <div class="comments__title">
                    ...
                    <ul class="comments__list">
                        <li class="comments__item">
                            <div class="comments__autor">
                                <img class="comments__avatar" src="{{ get_data_user('web','avatar') }}" alt="" />
                    ...
                    <form class="comments__form">
                        ...
                        <button type="submit" data-song = "{{$song->id}}" data-user="{{ Auth::check() ? auth()->user()->id : '' }}" class="sign__btn" id="submit_c">Send</button>
                    </form>
                </div>
            </div>
        </div>
